...
<div class="container-fluid p-0">
    ...
    <div class="header-section" 
         style="background-image: url('{{ asset('images/vietnam.jpg') }}'); 
        ...
        <div class="text-center py-4 px-3 rounded" style="z-index: 2;">
            <h1 class="display-4 fw-bold">Explore Vietnam</h1>
            <p class="lead">Discover the Timeless Beauty of Vietnam with our specially curated travel packages. Experience vibrant culture, breathtaking landscapes, and tantalizing cuisine at affordable prices.</p>
        </div>
    </div>
</div>
...
<div class="container py-4">
    <h2 class="text-center mb-5">Vietnam Travel Packages</h2>
    <div class="row g-4">
