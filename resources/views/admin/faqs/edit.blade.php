                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-control @error('type') is-invalid @enderror" id="type" name="type" required>
                            <option value="all" {{ old('type', $faq->type) == 'all' ? 'selected' : '' }}>All</option>
                            <option value="booking" {{ old('type', $faq->type) == 'booking' ? 'selected' : '' }}>Booking</option>
                            <option value="payment" {{ old('type', $faq->type) == 'payment' ? 'selected' : '' }}>Payment</option>
                            <option value="travel" {{ old('type', $faq->type) == 'travel' ? 'selected' : '' }}>Travel</option>
                        </select>
                        @error('type')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-check form-switch mt-2">
                            <input type="checkbox" class="form-check-input" id="is_published" name="is_published" value="1" {{ old('is_published', $faq->is_published) ? 'checked' : '' }}>
