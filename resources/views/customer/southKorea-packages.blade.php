...
<div class="container-fluid p-0">
    ...
    <div class="header-section" 
         style="background-image: url('{{ asset('images/south-korea.jpg') }}'); 
        ...
        <div class="text-center py-4 px-3 rounded" style="z-index: 2;">
            <h1 class="display-4 fw-bold">Explore South Korea</h1>
            <p class="lead">Unveil the Charm of South Korea with our specially curated travel packages. Experience dynamic cities, stunning natural beauty, and world-renowned cuisine at affordable prices.</p>
        </div>
    </div>
</div>
...
<div class="container py-4">
    <h2 class="text-center mb-5">South Korea Travel Packages</h2>
    <div class="row g-4">
            ...
            <div class="col-md-4 d-flex">
                <div class="card shadow-sm w-100">
                    <div class="card-img-container" style="height: 200px; overflow: hidden; display: flex; justify-content: center; align-items: center; background-color: #f8f9fa;">
                        <img src="{{ asset($package->image) }}" class="card-img-top" alt="{{ $package->name }}" style="max-height: 100%; max-width: 100%; object-fit: cover;">
                    </div>
